...
const profileKnowsAboutByLanguage = {
  en: [
    "PHP backend and web development",
    "CakePHP",
    "Legacy PHP modernization",
    "System integration",
    "REST API and JSON-RPC integration",
    "Asynchronous PHP with ReactPHP",
    "Event-driven architecture",
    "Automated testing with PHPUnit",
    "Linux services and systemd",
    "AI-assisted software development with OpenAI Codex and Claude Code",
    "Software for pharmacies and blister centers",
    "Medication management software",
    "Patient-specific blister production",
    "Pharmaceutical logistics",
    "Medication verification",
    "securPharm/NMVS",
    "WWKS2",
    "BD Rowa automated storage systems",
    "TOTP-based two-factor authentication (RFC 6238) and HOTP (RFC 4226)",
    "Authentication and session security",
    "Role-based access control (RBAC)",
    "Database migrations",
    "Security testing",
    "VoIP, Asterisk, and telecom billing",
    "WebRTC"
  ],
  de: [
    "PHP-Backend- und Webentwicklung",
    "CakePHP",
    "Modernisierung von Legacy-PHP-Anwendungen",
    "Systemintegration",
    "Integration von REST-APIs und JSON-RPC",
    "Asynchrones PHP mit ReactPHP",
    "Ereignisgesteuerte Architektur",
    "Automatisierte Tests mit PHPUnit",
    "Linux-Dienste und systemd",
    "KI-gestützte Softwareentwicklung mit OpenAI Codex und Claude Code",
    "Software für Apotheken und Blisterzentren",
    "Software für Medikationsmanagement",
    "Patientenindividuelle Verblisterung",
    "Pharmalogistik",
    "Arzneimittelverifikation",
    "securPharm/NMVS",
    "WWKS2",
    "Automatisierte Lagersysteme von BD Rowa",
    "TOTP-basierte Zwei-Faktor-Authentifizierung (RFC 6238) und HOTP (RFC 4226)",
    "Authentifizierungs- und Sitzungssicherheit",
    "Rollenbasierte Zugriffskontrolle (RBAC)",
    "Datenbankmigrationen",
    "Sicherheitstests",
    "VoIP, Asterisk und Telekommunikationsabrechnung",
    "WebRTC"
  ],
  es: [
    "Desarrollo backend y web con PHP",
    "CakePHP",
    "Modernización de aplicaciones PHP heredadas",
    "Integración de sistemas",
    "Integración de API REST y JSON-RPC",
    "PHP asíncrono con ReactPHP",
    "Arquitectura orientada a eventos",
    "Pruebas automatizadas con PHPUnit",
    "Servicios Linux y systemd",
    "Desarrollo de software asistido por IA con OpenAI Codex y Claude Code",
    "Software para farmacias y centros de producción de blísteres",
    "Software para la gestión de la medicación",
    "Producción de blísteres personalizados",
    "Logística farmacéutica",
    "Verificación de medicamentos",
    "securPharm/NMVS",
    "WWKS2",
    "Sistemas automatizados de almacenamiento BD Rowa",
    "Autenticación de dos factores basada en TOTP (RFC 6238) y HOTP (RFC 4226)",
    "Seguridad de la autenticación y las sesiones",
    "Control de acceso basado en roles (RBAC)",
    "Migraciones de bases de datos",
    "Pruebas de seguridad",
    "VoIP, Asterisk y facturación de telecomunicaciones",
    "WebRTC"
  ],
  fr: [
    "Développement backend PHP et web",
    "CakePHP",
    "Modernisation d’applications PHP historiques",
    "Intégration de systèmes",
    "Intégration d’API REST et de JSON-RPC",
    "PHP asynchrone avec ReactPHP",
    "Architecture événementielle",
    "Tests automatisés avec PHPUnit",
    "Services Linux et systemd",
    "Développement logiciel assisté par l’IA avec OpenAI Codex et Claude Code",
    "Logiciels pour les pharmacies et les centres de préparation de doses",
    "Logiciels de gestion des traitements",
    "Préparation personnalisée des doses",
    "Logistique pharmaceutique",
    "Vérification des médicaments",
    "securPharm/NMVS",
    "WWKS2",
    "Systèmes de stockage automatisé BD Rowa",
    "Authentification à deux facteurs basée sur TOTP (RFC 6238) et HOTP (RFC 4226)",
    "Sécurité de l’authentification et des sessions",
    "Contrôle d’accès basé sur les rôles (RBAC)",
    "Migrations de bases de données",
    "Tests de sécurité",
    "VoIP, Asterisk et facturation télécom",
    "WebRTC"
  ],
  uk: [
    "PHP-бекенд і веброзробка",
    "CakePHP",
    "Модернізація успадкованих PHP-застосунків",
    "Системна інтеграція",
    "Інтеграція REST API та JSON-RPC",
    "Асинхронний PHP із ReactPHP",
    "Подієво-орієнтована архітектура",
    "Автоматизоване тестування з PHPUnit",
    "Linux-сервіси та systemd",
    "Розробка ПЗ за допомогою ШІ з OpenAI Codex і Claude Code",
    "ПЗ для аптек і блістер-центрів",
    "ПЗ для керування лікарським забезпеченням",
    "Виробництво персоналізованих блістерів",
    "Фармацевтична логістика",
    "Перевірка лікарських засобів",
    "securPharm/NMVS",
    "WWKS2",
    "Автоматизовані системи зберігання BD Rowa",
    "Двофакторна автентифікація на базі TOTP (RFC 6238) і HOTP (RFC 4226)",
    "Безпека автентифікації та сесій",
    "Керування доступом на основі ролей (RBAC)",
    "Міграції баз даних",
    "Тестування безпеки",
    "VoIP, Asterisk і телекомунікаційний білінг",
    "WebRTC"
  ],
  ru: [
    "PHP-бэкенд и веб-разработка",
    "CakePHP",
    "Модернизация унаследованных PHP-приложений",
    "Системная интеграция",
    "Интеграция REST API и JSON-RPC",
    "Асинхронный PHP с ReactPHP",
    "Событийно-ориентированная архитектура",
    "Автоматизированное тестирование с PHPUnit",
    "Linux-сервисы и systemd",
    "Разработка ПО с помощью ИИ с OpenAI Codex и Claude Code",
    "ПО для аптек и блистер-центров",
    "ПО для управления лекарственным обеспечением",
    "Производство персонализированных блистеров",
    "Фармацевтическая логистика",
    "Проверка лекарственных препаратов",
    "securPharm/NMVS",
    "WWKS2",
    "Автоматизированные системы хранения BD Rowa",
    "Двухфакторная аутентификация на базе TOTP (RFC 6238) и HOTP (RFC 4226)",
    "Безопасность аутентификации и сессий",
    "Управление доступом на основе ролей (RBAC)",
    "Миграции баз данных",
    "Тестирование безопасности",
    "VoIP, Asterisk и телеком-биллинг",
    "WebRTC"
  ]
};
...
function replaceStructuredData(html, pageUrl, language, dictionary) {
  ...
  structuredData.mainEntity.knowsAbout = profileKnowsAboutByLanguage[language];
  structuredData.mainEntity.alumniOf.name = dictionary.education_university;
