(function () {
  ...
  var translations = {
    en: {
      ...
      summary_body: "Since 2024, my work has focused on software for medication management and patient-specific blister production, medication verification, pharmaceutical logistics, and automated medication storage. I also bring extensive experience in VoIP, telecom billing, and Linux-based services.",
      summary_languages_label: "Languages:",
      summary_languages: "English (B2), German (B1), Ukrainian (native), Russian (fluent).",
      ...
      lighttelecom_company: "LightTelecom LLC, Ukraine",
      ...
      lighttelecom_item_2: "As lead software developer, designed and implemented the integration of telephony platforms with customers' CRM systems and other business applications.",
      lighttelecom_item_3: "Managed and supported 40+ customer installations in production.",
      store_role: "Owner and Managing Director, Online Store Project Lead & Software Developer",
      store_company: "Computer equipment store",
      store_item_1: "Managed the store, day-to-day operations, and business development.",
      store_item_2: "Developed, extended, and maintained the technical side of the company's online store.",
      wellconstruction_role: "Research Assistant & Software Engineer",
      wellconstruction_company: "WellConstruction LLC, Ukraine",
      ...
      sip_role: "Developer and Maintainer",
      sip_description: "Personal software project: cloud IP PBX at",
      sip_item_1: "Develop and maintain the platform based on Linux, Asterisk, and A2Billing.",
      a2billing_role: "Open-source Project Maintainer",
      a2billing_project: "A2Billing — AGPLv3 telecom billing platform",
      a2billing_item_1: "Maintain and extend the PHP/MySQL codebase and its integration with Asterisk.",
    ...
    de: {
      ...
      summary_body: "Seit 2024 konzentriere ich mich auf Software für Medikationsmanagement und patientenindividuelle Verblisterung, Arzneimittelverifikation, Pharmalogistik und automatisierte Arzneimittellagerung. Darüber hinaus bringe ich langjährige Erfahrung mit VoIP, Telekommunikationsabrechnung und Linux-basierten Diensten mit.",
      ...
      lighttelecom_item_2: "Als leitender Softwareentwickler konzipierte und realisierte ich die Integration von Telefonieplattformen in CRM-Systeme und weitere Geschäftsanwendungen der Kunden.",
      lighttelecom_item_3: "Ich betreute und unterstützte mehr als 40 Kundeninstallationen im Produktivbetrieb.",
      store_role: "Inhaber und Geschäftsführer, Projektleiter des Onlineshops & Softwareentwickler",
      ...
      store_item_2: "Ich entwickelte, erweiterte und betrieb den Onlineshop des Unternehmens technisch.",
      ...
      chrome_store: "Chrome Web Store:",
      sip_role: "Entwickler und Maintainer",
      sip_description: "Persönliches Softwareprojekt: Cloud-IP-Telefonanlage unter",
      sip_item_1: "Ich entwickle und pflege die Plattform auf Basis von Linux, Asterisk und A2Billing.",
      a2billing_role: "Maintainer des Open-Source-Projekts",
      a2billing_project: "A2Billing — AGPLv3-lizenzierte Telekommunikations-Abrechnungsplattform",
      a2billing_item_1: "Ich pflege und erweitere die PHP-/MySQL-Codebasis sowie ihre Anbindung an Asterisk.",
    ...
    es: {
      ...
      summary_body: "Desde 2024, mi trabajo se centra en software para la gestión de la medicación y la producción de blísteres personalizados, la verificación de medicamentos, la logística farmacéutica y el almacenamiento automatizado de medicamentos. Mi experiencia productiva con securPharm/NMVS en Alemania es transferible a integraciones con SEVeM en España dentro del marco europeo EMVS. También cuento con una amplia experiencia en VoIP, facturación de telecomunicaciones y servicios basados en Linux.",
      summary_languages_label: "Idiomas:",
      summary_languages: "inglés (B2), alemán (B1), ucraniano (nativo) y ruso (fluido).",
      ...
      lighttelecom_company: "LightTelecom LLC, Ucrania",
      ...
      lighttelecom_item_2: "Como desarrollador de software principal, diseñé e implementé la integración de plataformas de telefonía con los sistemas CRM y otras aplicaciones de negocio de los clientes.",
      lighttelecom_item_3: "Gestioné y di soporte a más de 40 instalaciones de clientes en producción.",
      store_role: "Propietario y director general, jefe de proyecto de la tienda online y desarrollador de software",
      ...
      store_item_2: "Desarrollé, amplié y mantuve la parte técnica de la tienda online de la empresa.",
      wellconstruction_role: "Asistente de investigación e ingeniero de software",
      wellconstruction_company: "WellConstruction LLC, Ucrania",
      ...
      chrome_store: "Chrome Web Store:",
      sip_role: "Desarrollador y responsable de mantenimiento",
      sip_description: "Proyecto de software personal: centralita IP en la nube en",
      sip_item_1: "Desarrollo y mantengo la plataforma basada en Linux, Asterisk y A2Billing.",
      a2billing_role: "Responsable del proyecto de código abierto",
      a2billing_project: "A2Billing — plataforma de facturación de telecomunicaciones con licencia AGPLv3",
      a2billing_item_1: "Mantengo y amplío el código PHP/MySQL y su integración con Asterisk.",
    ...
    fr: {
      ...
      summary_body: "Depuis 2024, mon travail porte principalement sur les logiciels de gestion des traitements et de préparation personnalisée des doses, la vérification des médicaments, la logistique pharmaceutique et le stockage automatisé de médicaments. J’ai également une solide expérience de la VoIP, de la facturation télécom et des services sous Linux.",
      summary_languages_label: "Langues :",
      summary_languages: "anglais (B2), allemand (B1), ukrainien (langue maternelle), russe (courant).",
      ...
      lighttelecom_item_2: "En tant que développeur logiciel principal, j’ai conçu et réalisé l’intégration de plateformes de téléphonie aux systèmes CRM et autres applications métier des clients.",
      lighttelecom_item_3: "J’ai administré et assuré le support de plus de 40 installations clientes en production.",
      store_role: "Propriétaire et directeur général, chef de projet de la boutique en ligne et développeur logiciel",
      ...
      store_item_2: "J’ai développé, fait évoluer et assuré la maintenance technique de la boutique en ligne de l’entreprise.",
      ...
      chrome_store: "Chrome Web Store :",
      sip_role: "Développeur et responsable de la maintenance",
      sip_description: "Projet logiciel personnel : service de téléphonie IP hébergé dans le cloud sur",
      sip_item_1: "Je développe et maintiens la plateforme basée sur Linux, Asterisk et A2Billing.",
      a2billing_role: "Mainteneur du projet open source",
      a2billing_project: "A2Billing — plateforme de facturation télécom sous licence AGPLv3",
      a2billing_item_1: "Je maintiens et fais évoluer la base de code PHP/MySQL ainsi que son intégration avec Asterisk.",
    ...
    uk: {
      ...
      summary_body: "З 2024 року я зосереджений на ПЗ для керування лікарським забезпеченням та індивідуального фасування ліків за дозами, перевірці лікарських засобів, фармацевтичній логістиці й автоматизованому зберіганні ліків. Також маю багаторічний досвід у VoIP, телеком-білінгу та сервісах на базі Linux.",
      summary_languages_label: "Мови:",
      summary_languages: "англійська (B2), німецька (B1), українська (рідна), російська (вільно).",
      ...
      lighttelecom_company: "ТОВ Лайт Телеком, Україна",
      lighttelecom_item_1: "Керував упровадженням IP-АТС і систем телекомунікаційного білінгу для середніх і великих компаній.",
      lighttelecom_item_2: "Як провідний розробник програмного забезпечення, спроєктував і реалізував інтеграцію телефонних платформ із CRM-системами та іншими бізнес-застосунками клієнтів.",
      lighttelecom_item_3: "Керував роботою понад 40 клієнтських інсталяцій у продакшені та забезпечував їхню підтримку.",
      store_role: "Власник і генеральний директор, керівник проєкту інтернет-магазину та розробник програмного забезпечення",
      store_company: "Магазин комп’ютерної техніки",
      store_item_1: "Керував магазином, щоденною роботою та розвитком бізнесу.",
      store_item_2: "Розробляв, розширював і технічно супроводжував інтернет-магазин компанії.",
      wellconstruction_role: "Науковий співробітник та інженер-програміст",
      wellconstruction_company: "ТОВ Добробуд, Україна",
      ...
      chrome_store: "Chrome Web Store:",
      sip_role: "Розробник і мейнтейнер",
      sip_description: "Особистий програмний проєкт: хмарна IP-АТС на",
      ...
      a2billing_project: "A2Billing — телекомунікаційна білінгова платформа під ліцензією AGPLv3",
      a2billing_item_1: "Підтримую та розширюю кодову базу на PHP/MySQL та її інтеграцію з Asterisk.",
    ...
    ru: {
      ...
      summary_body: "С 2024 года моя работа сосредоточена на ПО для управления лекарственным обеспечением и индивидуальной дозированной упаковки лекарств, проверке лекарственных препаратов, фармацевтической логистике и автоматизированном хранении лекарств. Также у меня многолетний опыт работы с VoIP, телеком-биллингом и сервисами на базе Linux.",
      summary_languages_label: "Языки:",
      summary_languages: "английский (B2), немецкий (B1), украинский (родной), русский (свободно).",
      ...
      lighttelecom_company: "ООО Лайт Телеком, Украина",
      lighttelecom_item_1: "Руководил внедрением IP-АТС и систем телекоммуникационного биллинга для средних и крупных компаний.",
      lighttelecom_item_2: "Как ведущий разработчик программного обеспечения, спроектировал и реализовал интеграцию телефонных платформ с CRM-системами и другими бизнес-приложениями клиентов.",
      lighttelecom_item_3: "Управлял работой более 40 клиентских инсталляций в продакшене и обеспечивал их поддержку.",
      store_role: "Владелец и генеральный директор, руководитель проекта интернет-магазина и разработчик программного обеспечения",
      store_company: "Магазин компьютерной техники",
      store_item_1: "Управлял магазином, ежедневной работой и развитием бизнеса.",
      store_item_2: "Разрабатывал, расширял и технически сопровождал интернет-магазин компании.",
      wellconstruction_role: "Научный сотрудник и инженер-программист",
      wellconstruction_company: "ООО Добробуд, Украина",
      ...
      chrome_store: "Chrome Web Store:",
      sip_role: "Разработчик и мейнтейнер",
      sip_description: "Личный программный проект: облачная IP-АТС на",
      ...
      a2billing_project: "A2Billing — телекоммуникационная биллинговая платформа под лицензией AGPLv3",
      a2billing_item_1: "Поддерживаю и расширяю кодовую базу на PHP/MySQL и её интеграцию с Asterisk.",
  ...
  var caseStudyLinks = {
    en: {
      ...
      totp: "/en/case-studies/totp-2fa-patient-data-security/"
    },
    de: {
      ...
      totp: "/de/fallstudien/totp-2fa-patientendaten-sicherheit/"
    },
    es: {
      ...
      totp: "/es/casos/totp-2fa-seguridad-datos-pacientes/"
    }
  };
  ...
  function linkCaseStudyTechnologies(localizedCaseStudyLinks) {
    var items = document.querySelectorAll("[data-case-study-technology]");

    for (var index = 0; index < items.length; index += 1) {
      var item = items[index];
      var caseStudyKey = item.getAttribute("data-case-study-technology");
      var pattern = caseStudyTechnologyPatterns[caseStudyKey];
      var caseStudyUrl = localizedCaseStudyLinks[caseStudyKey];
      var text = item.textContent;
      var match = pattern && text.match(pattern);

      if (!match || !caseStudyUrl) {
        continue;
      }

      var anchor = document.createElement("a");
      anchor.setAttribute("href", caseStudyUrl);
      anchor.setAttribute("data-case-study", caseStudyKey);
      anchor.textContent = match[0];

      item.textContent = "";
      item.appendChild(document.createTextNode(text.slice(0, match.index)));
      item.appendChild(anchor);
      item.appendChild(document.createTextNode(text.slice(match.index + match[0].length)));
    }
  }
  ...
  function translatePage(language) {
    ...
    linkCaseStudyTechnologies(localizedCaseStudyLinks);
